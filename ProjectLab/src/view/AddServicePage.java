...
public class AddServicePage {
	...
	private void addComponent(Stage stage) {
		...
		// set the function that will happen when addBtn is clicked
		addBtn.setOnAction(e -> {
			...
			// call ServiceController to add new service
			ServiceController.addService(name, description, price, duration);
		});
		...
		stage.setTitle("Add Service Page");
	}
